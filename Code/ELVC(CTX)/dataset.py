...
class HEVCBDataSet(data.Dataset):
    def __init__(self, root="", filelist="G:/wangyiming/data/test_data/HEVC_filelists/B_test.txt", testfull=True):
        ...
        for folder in folders:
            ...
            for i in range(framerange):
                inputpath = []
                for j in range(gop):
                    inputpath.append(os.path.join(root, seq, 'BT.601','im' + str(i * gop + j + 1).zfill(5) + '.png'))
